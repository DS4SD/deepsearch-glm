...
ExternalProject_Add(extlib_pcre2
    ...
    UPDATE_COMMAND ""
    #CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${EXTERNALS_PREFIX_PATH} -DBUILD_SHARED_LIBS=OFF -DBUILD_STATIC_LIBS=ON
    CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${EXTERNALS_PREFIX_PATH} -DCMAKE_INSTALL_LIBDIR=${EXTERNALS_PREFIX_PATH}/lib -DBUILD_SHARED_LIBS=OFF -DBUILD_STATIC_LIBS=ON
